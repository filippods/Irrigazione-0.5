...
from log_manager import log_event, _day_of_year, _get_formatted_date
...
async def check_programs():
    ...
    settings = load_user_settings()
    automatic_programs_enabled = settings.get('automatic_programs_enabled', True)  # Default a True
    ...
    for program_id, program in programs.items():
        ...
        if program.get('automatic_enabled', True) == False:  # Controlla esplicitamente se è False
            continue
